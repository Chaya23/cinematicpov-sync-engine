    ...
    with st.status("🎬 Aggressive Bypass & Processing...") as status:
        try:
            ...
            if response.candidates:
                ...
                st.error("AI blocked content. This usually happens with URL-metadata. Trying 'File Upload' bypasses this.")
...
if st.session_state.processed:
    ...
    with col2:
        ...
        st.download_button("📥 Save Novel", create_docx(f"{pov_choice} Chapter", st.session_state.chapter), "Novel.docx")
